...
IMG_CATEGORIES = {0:'Safe Driving', 1:'Texting - Right', 2:'Talking on phone - Right', 3:'Texting - Left', 4:'Talking on phone - Left', 5:'Adjusting Radio', 6:'Drinking', 7:'Reaching Behind', 8:'Hair and Makeup', 9:'Talking to Passenger'}

# Specifying the size of image, same as used for training
IMG_SIZE = 224

#Load the model for predictions
pred_model = load_model('./model/Final_DL_Model.hdf5')
...
#Capturing the video with usb camera in driver simulation environment
vc = cv2.VideoCapture(0) #For laptop camera
...
while True:
	...
	if writer is None:
		...
		writer = cv2.VideoWriter('./live_video_output/live_output_video.mp4', fourcc, 5, (W, H), True)
